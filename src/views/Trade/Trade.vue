<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(good,index) in detailArrayList" :key="index">
          <li>
            <img :src="good.imgUrl" style="width: 100px;height: 100px" alt="">
          </li>
          <li>
            <p>{{ good.skuName }}</p>
            <h4>7天无理由退货</h4>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b><i>{{ cartGoodInfo.totalNum }}</i>件商品，总商品金额</b>
          <span>¥{{ cartGoodInfo.totalAmount }}.00</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">应付金额:<span>¥{{ cartGoodInfo.totalAmount }}.00</span></div>
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch('getCartGoodInfo');
  },
  computed: {
    defaultAddress() {
    ...
    ...mapState({
      ...
      cartGoodInfo: state => state.trade.cartGoodInfo,
    }),
  },
  methods: {
    ...
    async submitOrder() {
      //整理参数
      //交易编码
      const {tradeNo} = this.cartGoodInfo;
